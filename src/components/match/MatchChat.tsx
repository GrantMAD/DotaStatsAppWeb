  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between px-4">
        <h3 className="text-sm font-black text-white uppercase tracking-widest">Communication Log</h3>
        <button
        ...
        {filteredChat.length > 0 ? (
          <div className="divide-y divide-white/5">
            {filteredChat.map((msg, idx) => {
              ...
              return (
                <div key={idx} className="flex items-start gap-4 p-4 hover:bg-white/[0.02] transition-colors">
                  ...
                  {player && (
                    <img 
                      ...
                      className="w-8 h-5 rounded shadow-lg border border-white/10 mt-0.5 shrink-0" 
                      alt="hero" 
                    />
                  )}
                    ...
                    <div className="flex flex-wrap items-baseline gap-2">
                      ...
                      <div className="flex items-baseline gap-1.5 min-w-0">
                        ...
                        <p className={cn(
                          ...
                          isWheel ? "italic text-gaming-accent font-medium" : "text-white font-medium"
                        )}>
                          {phrase}
                        </p>
                      </div>
