    ...
    return (
      <div className="bg-[var(--glass-start)] backdrop-blur-md border border-[var(--card-border)] p-3 rounded-xl shadow-2xl">
        ...
        <p className="text-sm font-black text-foreground italic">
          Win Rate: <span className={payload[0].value >= 50 ? "text-win" : "text-loss"}>
  ...
  if (chartData.length === 0) {
    return (
      <GlassCard className="p-6 h-[400px] flex items-center justify-center border-dashed">
        <p className="text-gray-500 font-bold italic uppercase tracking-widest text-[10px]">No duration data found</p>
      </GlassCard>
    );
  }
    ...
    >
      <GlassCard className="p-6 h-full flex flex-col">
        <div className="flex justify-between items-start mb-6">
          <div>
            <h3 className="text-xs font-black uppercase tracking-widest text-foreground italic">Power Spikes</h3>
            <p className="text-[8px] font-bold text-gray-500 uppercase">Win Rate by Game Duration</p>
          </div>
          <div className="px-2 py-0.5 rounded bg-gaming-accent/10 border border-gaming-accent/20">
            <span className="text-[8px] font-black text-gaming-accent uppercase tracking-tighter italic">Live Meta</span>
          </div>
        </div>

        <div className="flex-1 w-full mt-2 relative" style={{ minHeight: '250px' }}>
        ...
        <div className="mt-4 pt-4 border-t border-[var(--card-border)] flex justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-[8px] font-black text-gray-500 uppercase tracking-widest italic">Win Rate %</span>
          </div>
