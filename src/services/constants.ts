...
export const HEROES: Record<number, { name: string; localized_name: string; roles: string[] }> = {
  ...
  2: { name: "npc_dota_hero_axe", localized_name: "Axe", roles: ["Initiator", "Durable", "Disabler", "Carry"] },
  3: { name: "npc_dota_hero_bane", localized_name: "Bane", roles: ["Support", "Disabler", "Nuker", "Durable"] },
  4: { name: "npc_dota_hero_bloodseeker", localized_name: "Bloodseeker", roles: ["Carry", "Disabler", "Nuker", "Initiator"] },
  5: { name: "npc_dota_hero_crystal_maiden", localized_name: "Crystal Maiden", roles: ["Support", "Disabler", "Nuker"] },
  6: { name: "npc_dota_hero_drow_ranger", localized_name: "Drow Ranger", roles: ["Carry", "Disabler", "Pusher"] },
  7: { name: "npc_dota_hero_earthshaker", localized_name: "Earthshaker", roles: ["Support", "Initiator", "Disabler", "Nuker"] },
  8: { name: "npc_dota_hero_juggernaut", localized_name: "Juggernaut", roles: ["Carry", "Pusher", "Escape"] },
  9: { name: "npc_dota_hero_mirana", localized_name: "Mirana", roles: ["Carry", "Support", "Escape", "Nuker", "Disabler"] },
  ...
  12: { name: "npc_dota_hero_phantom_lancer", localized_name: "Phantom Lancer", roles: ["Carry", "Escape", "Pusher", "Nuker"] },
  13: { name: "npc_dota_hero_puck", localized_name: "Puck", roles: ["Initiator", "Disabler", "Escape", "Nuker"] },
  14: { name: "npc_dota_hero_pudge", localized_name: "Pudge", roles: ["Disabler", "Initiator", "Durable", "Nuker"] },
  15: { name: "npc_dota_hero_razor", localized_name: "Razor", roles: ["Carry", "Durable", "Nuker", "Pusher"] },
  16: { name: "npc_dota_hero_sand_king", localized_name: "Sand King", roles: ["Initiator", "Disabler", "Support", "Nuker", "Escape"] },
  17: { name: "npc_dota_hero_storm_spirit", localized_name: "Storm Spirit", roles: ["Carry", "Escape", "Nuker", "Initiator", "Disabler"] },
  18: { name: "npc_dota_hero_sven", localized_name: "Sven", roles: ["Carry", "Disabler", "Initiator", "Durable", "Nuker"] },
  19: { name: "npc_dota_hero_tiny", localized_name: "Tiny", roles: ["Carry", "Nuker", "Pusher", "Initiator", "Durable", "Disabler"] },
  ...
  22: { name: "npc_dota_hero_zuus", localized_name: "Zeus", roles: ["Nuker", "Carry"] },
  ...
  27: { name: "npc_dota_hero_shadow_shaman", localized_name: "Shadow Shaman", roles: ["Support", "Pusher", "Disabler", "Nuker", "Initiator"] },
  28: { name: "npc_dota_hero_slardar", localized_name: "Slardar", roles: ["Carry", "Durable", "Initiator", "Disabler", "Escape"] },
  29: { name: "npc_dota_hero_tidehunter", localized_name: "Tidehunter", roles: ["Initiator", "Durable", "Disabler", "Nuker", "Carry"] },
  30: { name: "npc_dota_hero_witch_doctor", localized_name: "Witch Doctor", roles: ["Support", "Nuker", "Disabler"] },
  ...
  33: { name: "npc_dota_hero_enigma", localized_name: "Enigma", roles: ["Disabler", "Initiator", "Pusher"] },
  34: { name: "npc_dota_hero_tinker", localized_name: "Tinker", roles: ["Carry", "Nuker", "Pusher"] },
  ...
  38: { name: "npc_dota_hero_beastmaster", localized_name: "Beastmaster", roles: ["Initiator", "Disabler", "Durable", "Nuker"] },
  39: { name: "npc_dota_hero_queenofpain", localized_name: "Queen of Pain", roles: ["Carry", "Nuker", "Escape"] },
  40: { name: "npc_dota_hero_venomancer", localized_name: "Venomancer", roles: ["Support", "Nuker", "Initiator", "Pusher", "Disabler"] },
  ...
  43: { name: "npc_dota_hero_death_prophet", localized_name: "Death Prophet", roles: ["Carry", "Pusher", "Nuker", "Disabler"] },
  44: { name: "npc_dota_hero_phantom_assassin", localized_name: "Phantom Assassin", roles: ["Carry", "Escape"] },
  45: { name: "npc_dota_hero_pugna", localized_name: "Pugna", roles: ["Nuker", "Pusher"] },
  ...
  48: { name: "npc_dota_hero_luna", localized_name: "Luna", roles: ["Carry", "Nuker", "Pusher"] },
  49: { name: "npc_dota_hero_dragon_knight", localized_name: "Dragon Knight", roles: ["Carry", "Pusher", "Durable", "Disabler", "Initiator", "Nuker"] },
  ...
  52: { name: "npc_dota_hero_leshrac", localized_name: "Leshrac", roles: ["Carry", "Support", "Nuker", "Pusher", "Disabler"] },
  53: { name: "npc_dota_hero_furion", localized_name: "Nature's Prophet", roles: ["Carry", "Pusher", "Escape", "Nuker"] },
  54: { name: "npc_dota_hero_life_stealer", localized_name: "Lifestealer", roles: ["Carry", "Durable", "Escape", "Disabler"] },
  55: { name: "npc_dota_hero_dark_seer", localized_name: "Dark Seer", roles: ["Initiator", "Escape", "Disabler"] },
  56: { name: "npc_dota_hero_clinkz", localized_name: "Clinkz", roles: ["Carry", "Escape", "Pusher"] },
  57: { name: "npc_dota_hero_omniknight", localized_name: "Omniknight", roles: ["Support", "Durable", "Nuker"] },
  58: { name: "npc_dota_hero_enchantress", localized_name: "Enchantress", roles: ["Support", "Pusher", "Durable", "Disabler"] },
  ...
  61: { name: "npc_dota_hero_broodmother", localized_name: "Broodmother", roles: ["Carry", "Pusher", "Escape", "Nuker"] },
  ...
  107: { name: "npc_dota_hero_earth_spirit", localized_name: "Earth Spirit", roles: ["Nuker", "Escape", "Disabler", "Initiator", "Durable"] },
  108: { name: "npc_dota_hero_abyssal_underlord", localized_name: "Underlord", roles: ["Support", "Nuker", "Disabler", "Durable", "Escape"] },
  109: { name: "npc_dota_hero_terrorblade", localized_name: "Terrorblade", roles: ["Carry", "Pusher", "Nuker"] },
  110: { name: "npc_dota_hero_phoenix", localized_name: "Phoenix", roles: ["Support", "Nuker", "Initiator", "Escape", "Disabler"] },
  111: { name: "npc_dota_hero_oracle", localized_name: "Oracle", roles: ["Support", "Nuker", "Disabler", "Escape"] },
  112: { name: "npc_dota_hero_winter_wyvern", localized_name: "Winter Wyvern", roles: ["Support", "Disabler", "Nuker"] },
  ...
  121: { name: "npc_dota_hero_grimstroke", localized_name: "Grimstroke", roles: ["Support", "Nuker", "Disabler", "Escape"] },
  ...
  136: { name: "npc_dota_hero_marci", localized_name: "Marci", roles: ["Support", "Carry", "Initiator", "Disabler", "Escape"] },
